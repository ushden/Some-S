...
type NotProcessedInclude = string | {relation: string; required?: boolean; scope?: INotProcessedQueryScope};

type ProcessedInclude = IncludeOptions | string;
type ProcessedOrder = [string, Order];
type ProcessedAttributesObject = {exclude?: string[]; include: string[]} | {exclude: string[]; include?: string[]};
